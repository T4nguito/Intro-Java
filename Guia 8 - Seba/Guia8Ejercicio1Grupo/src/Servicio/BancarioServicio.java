...
public class BancarioServicio
{
    ...
    public CuentaBancaria craearCuenta() {
        ...
        final int numcuenta = this.sc.nextInt();
        System.out.println("==============================");
        System.out.println("Ingrese el DNI ");
        final long dni = this.sc.nextLong();
        System.out.println("==============================");
        System.out.println("Ingrese saldo inicial");
        final double saldo = this.sc.nextDouble();
        return new CuentaBancaria(numcuenta, dni, saldo);
    }
    
    public void ingresar(final CuentaBancaria cuenta, final double cantidad) {
